        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (nota1Valida && nota2Valida)
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    {
                        connection.Open();
                        string query = "INSERT INTO [dbo].[Alunos] (nome, semestre1, semestre2, media_anual, status, ano) VALUES (@Nome_Aluno, @Semestre1, @Semestre2, @Media_Anual, @Status, @Ano)";
                        ...
                        command.Parameters.AddWithValue("@Ano", anoAtual);
